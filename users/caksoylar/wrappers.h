...
#define _________________QWERTY_R2_________________    KC_H,    HM_J,    HM_K,    HM_L,    HM_QUOT
...
#define __________________GAM_L2___________________    KC_A,    KC_S,    KC_D,    KC_F,    KC_G
#define __________________GAM_R2___________________    KC_H,    KC_J,    KC_K,    KC_L,    TG_GAME
...
#define __________________SYM_L3___________________    XXXXXXX, XXXXXXX, XXXXXXX, KC_SCLN, KC_AMPR
...
#define __________________SYM_R3___________________    KC_ASTR, KC_BSLS, XXXXXXX, XXXXXXX, XXXXXXX


#define __________________NAV_L1___________________    ALT_F4,  TAB_LT,  TAB_RT,  CTL_F4,  KC_VOLU
#define __________________NAV_L2___________________    KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT, KC_VOLD
#define __________________NAV_L3___________________    XXXXXXX, WIN_LT,  WIN_RT,  SFT_INS, KC_MPLY

#define __________________NAV_R1___________________    KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_PAUS
#define __________________NAV_R2___________________    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_CALC
...
#define __________________FUN_L3___________________    XXXXXXX, DSK_LT, DSK_RT, KC_F11,  KC_F12

#define __________________FUN_R1___________________    KC_CAPS, KC_P7,   KC_P8,   KC_P9,   KC_COMM
#define __________________FUN_R2___________________    KC_NLCK, KC_P4,   KC_P5,   KC_P6,   KC_DOT
#define __________________FUN_R3___________________    KC_P0,   KC_P1,   KC_P2,   KC_P3,   KC_PENT
